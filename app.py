...
with mechanism_tab:
    ...
    st.markdown(
        ...
        <div class="mechanism-card">
            ...
            経営が本当に知りたいのは、
            <strong>この仕組み全体が、会社として責任を引き受けられる構造になっているか（責任がどこにあるかを"ミスなく"自動で整理してくれるか）</strong>です。
            承認、ログ、チェックリストがあっても、異常時に誰が止めるのかが途中で消えるなら、<br>
            <strong>自律型AI時代にその仕組みは本番運用に入れられません。</strong>
        </div>
        """,
        unsafe_allow_html=True,
    )
